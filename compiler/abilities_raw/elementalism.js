    ...
    description: [
        {
            ...
            content: [
                ...
                `When you Unlock this Ability, choose 5 from the list of Effects to start with.`,
                `You can Unlock the remaining Effects by Spending 5 XP.`,
        ...
        },
        {
            ...
            content: [
                ...
                `You can deal <box>(1d4 × ESS) Cold Damage</box>, Maximized against Soaked Targets.`,
            ]
        },
        {
            type: "list",
        ...
        },
        {
            ...
            content: [
                ...
                `You can deal <box>(1d4 × ESS) Necrotic Damage</box>`,
            ]
        },
        {
            type: "list",
            content: [
                `<b>Mass Elementalism</b> (5 XP):`,
