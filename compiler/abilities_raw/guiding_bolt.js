module.exports = {
    ...
    reqs_full: [
        "<b>Spell:</b> 5 CS, (5 Enchantment | 10 Divination | 20 Evocation)",
    ],
    tags: [
        "Offense, Utility",
    ...
    description: [
        {
            type: "p",
            content: [
                `You create an orb of Light, which you shoot at a Target.`,
        ...
        },
        {
            ...
            content: [
                `<b>Light Effect:</b>`,
                `The Target glows, revealing them in Darkness, and Invisibility.`,
