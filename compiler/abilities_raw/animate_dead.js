    ...
    description: [
        {
            type: "p",
            content: [
                `When used, you animate corpse(s) into Undead(s).`,
                `At Cast you allocate up to <box>10 × ESS</box> PROXY, freely devided between Targeted corpses.`,
                `The Tier of the Undead depends on the PROXY Allocated: <box>PROXY = 10 × Tier</box>`,
                `The Undeads have <a href="undying.html" target="_blank">Undying</a>, <a href="essence_sustenance.html" target="_blank">Essence Sustenance</a>, and <b>Dark Vision</b>.`,
                `The Undeads have <box>(6 × Tier) Radiant Weakness</box>`,
            ],
        },
        {
            type: "p",
            content: [
                `Each Undead under Control occupies <box>(10 × Tier) PROXY</box>`,
        ...
        },
        {
            ...
            content: [
                ...
                `Claws and jaws are considered Natural Melee Weapons with <box>1d8 Base Damage</box>, <box>5 Armor-Pen</box>, and <b>Tier</b> of the Undead.`,
            ],
        },
        {
            type: "table",
            ...
            content: [
                ...
                ["WILL", "2"],
                ["EGO", "1"],
                ["Calculated Stats", "20 HP, 12 HD, 4 SP"],
        ...
        },
        {
            ...
            content: [
                ...
                ["WILL", "4"],
                ["EGO", "2"],
                ["Calculated Stats", "8 HP, 30 HD, 8 SP"],
