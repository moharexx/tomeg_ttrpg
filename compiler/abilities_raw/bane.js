module.exports = {
    ...
    reqs_short: [
        "10 CS, (5 Enchantment | 10 Anima | 20 Abjuration)",
    ],
    reqs_full: [
        "<b>Spell:</b> 10 CS, (5 Enchantment | 10 Anima | 20 Abjuration)",
    ],
    tags: [
        "Utility",
        "Ranged, Soul Save, Debuff",
    ...
    description: [
        {
            ...
            content: [
                ...
                `You can Bane Sensed Targets, but Spend no more than <box>2 × ESS</box> from the Pool on a single Target.`,
        ...
        },
        {
            ...
            content: [
                ...
                `For each Point of Bane the Target has a Reduction of 2 on Attacks and Mastery-Checks.`,
            ],
        },
        {
            type: "list",
