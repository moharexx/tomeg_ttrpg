    ...
    description: [
        ...
        },
        {
            ...
            content: [
                ...
                `Choose 1 Damage Type; <box>Physical | Heat | Cold | Bio | Demat | Thunder | Electric | Psychic | Radiant | Necrotic | Healing</box>`,
                `While Wielding, you can choose to gain a <box>2 × EP</box> Damage Bonus.`,
        ...
        },
        {
            ...
            content: [
                ...
                `For each Point of Resistance allocated to Radiant or Necrotic, choose either the HP or SP part.`,
                `If the User could benefit from multiple sources of this, choose only one!`,
        ...
        },
        {
            ...
            content: [
                ...
                `This Ability can be used as a <b>Main-Action</b> to Target up to 3 Armaments instead of 1.`,
