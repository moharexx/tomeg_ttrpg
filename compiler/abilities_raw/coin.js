    ...
    description: [
        {
            ...
            content: [
                ...
                "The small object loses it's power after the End of the Caster's Next Turn.",
        ...
        },
        {
            ...
            content: [
                ...
                `Being Hit multiple times from the same Line Attack will not Proc the Damage multiple times, but rather <a href="../main/mechanics.html#max_value">Maximalize</a> the Damage.`,
            ]
        },
        {
            type: "list",
            content: [
                ...
                "These 2 Projectiles must go in different Directions, so that they do not Hit the Same Target.",
        ...
        },
        {
            ...
            content: [
                ...
                "The Coin will have the Same To-Hit and Damage as the Original Attack and <box>40 / 80 × ESS^(1/3) Range</box>",
                ...
                "If an AOE Melee Attack Hits Multiple Coins, the Coins must go in different Directions, so that they do not Hit the Same Target.",
            ]
        },
        {
            type: "list",
    ...
    stats: [
        {
            ...
            content: [
                ...
                ["Coin Effect Duration", "Till End of Casters Next Turn"],
            ],
        },
    ],
}