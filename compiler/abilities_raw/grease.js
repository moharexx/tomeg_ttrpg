    ...
    description: [
        {
            ...
            content: [
                ...
                `On a Save Success, the Target doesn't have to make Saves for the next 1 Minute (20 Rounds) against that specific Grease Ability Instance.`,
        ...
        },
        {
            ...
            content: [
                ...
                `Soaked Effect clears the Grease Effect.`,
            ]
        },
        {
            type: "list",
