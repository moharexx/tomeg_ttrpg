module.exports = {
    ...
    reqs_full: [
        "<b>Spell:</b> 1000 CS, (1000 Conjuration | 1000 Transmutation | 1000 Enchantment)",
    ],
    tags: [
        "Utility, Unlock",
        "Creation",
    ...
    description: [
        {
            ...
            content: [
                ...
                `After the Cast Time a new Universe is born, or an already existing one's volume is increased.`,
            ],
        },
        {
            type: "list",
            content: [
                ...
                `The Universal Edge has a <box>CS Armor VS All</box>, and <box>(1000 × ESS) HP</box>`,
                `The Universal Edge will slowly Repair if Damaged, at a rate of <box>1% / Year</box>`,
                `Casting Genesis for the sake of Repair can Restore <box>(1000 × ESS) HP</box> to the Universal Edge.`,
                ...
                `Even a Looping Edge can be Damaged by something that can Target Intangible things.`,
            ],
        },
        {
            type: "list",
            content: [
                ...
                `The Interdimensional Void is an Infinite Dimensional Space, this does not mean there are Infinite Dimensional Objects in it.`,
        ...
        },
        {
            ...
            content: [
                ...
                `Rather than Creating a new Universe, choose one in Range, and if it's Edge has less than <box>(1000 × ESS) HP</box> then Instantly Destroy the Universe.`,
                `The Universal Edge will pop, and all Physical Targets must make a <box>VIT Save of ESS</box> or be instantly Dematerialized.`,
            ],
        },
        {
            type: "list",
            content: [
                ...
                `Create a new Universe inside of an Existing one, this Halves the Radius to <box>50 × ESS^(1/3)</box>.`,
                ...
                `The Shockwave has a Radius of <box>100 × ESS^(1/3)</box> and deals <box>5 × ESS Bludgeoning</box> Damage.`,
